...
return array(
	    // labels
		"item:object:mission" => "Career ConneXions Opportunity Platform",
	    ...
	    "missions:micromissions" => "Career ConneXions Opportunity Platform",
	    ...
	    "missions:application_paragraph" => "Please write out the message you wish to send to this opportunity creator.",
	    "missions:application_to" => "Jobs Marketplace Application to: ",
	    ...
	    "missions:accepts_invitation" => "%s accepts becoming an applicant to this opportunity.",
	    "missions:accepts_invitation_more" => "%s has accepted becoming an applicant for your opportunity ",
	    ...
	    "missions:mission_invitation" => "Opportunities Shared with You",
		...
		"missions:manager_permission_disclaimer" => "I have discussed participating in this opportunity type with my supervisor. I will seek my supervisors approval to participate should I be offered the opportunity.",
		...
		"missions:check_micro_missions" => "You should check out Micro-Missions! Opt in now to participate!",
		"missions:view" => "View",
		...
		"missions:participating_in_more" => "You are now a participant in this opportunity '%s'",
		...
		"missions:finalize_offer" => "Now you can make an offer to a candidate of your choice.",
		...
		"missions:acceptance_has_been_sent" => "The opportunity '%s' manager has been notified of your acceptance.",
		...
		"mission:has_been_completed" => "The opportunity '%s' has been completed. Feedback requests have been sent to the host manager and all participants.",
		...
		"missions:duplicating_this_mission" => "You are now duplicating the opportunity '%s'. All information except for manager information has been carried over from the original opportunity.",
		...
		"missions:admin_tool" =>"Opportunity Platform Tool",
		"missions:admin_tool_page" => "Opportunity Platform administrator tool page",
		...
		"missions:mission_finalize_acceptance_for" => "Micro-Mission acceptance for %s",
		"missions:finalize_acceptance" => "Accept Offer",
		"missions:offers_you_a_spot" => "Micro-Mission '%s' offers you a place",
		"missions:offers_you_a_spot_more" => "Micro-Mission '%s' is offering you a place. Please complete your acceptance here: ",
