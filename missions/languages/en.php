...
return array(
	    ...
	    "missions:oral" => "Please note that all search fields use AND logic to select Micro-Missions.  This means that adding more search fields will narrow the search results.",
