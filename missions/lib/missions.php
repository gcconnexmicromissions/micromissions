...
function mm_create_button_set_base($mission, $full_view=false) {
	...
	if(!$full_view) {
		$button_one = '<div id="read-more-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
				'href' => $mission->getURL(),
		...
		if($mission->owner_guid == elgg_get_logged_in_user_guid() && $mission->state != 'completed' && $mission->state != 'cancelled') {
			$button_one = '<div id="edit-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
	...
	$button_two = '<div id="share-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
	...
	if($mission->state != 'completed' && $mission->state != 'cancelled') {
		if ($mission->owner_guid == elgg_get_logged_in_user_guid()) {
			...
			$button_three ='<div id="invite-button-mission-' . $mission->guid . '" style="display:inline-block;">' .  elgg_view('output/url', array(
			...
			if(!$full_view && $candidate_total == $mission->number) {
				$button_three = '<div id="complete-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
			...
			$button_three = '<div id="apply-button-mission-' . $mission->guid . '" style="display:inline-block;">' . $apply_button = elgg_view('output/url', array(
			...
			if(check_entity_relationship($mission->guid, 'mission_tentative', elgg_get_logged_in_user_guid())) {
				$button_three = '<div id="accept-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
				...
				$button_four = '<div id="decline-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
			...
			if(check_entity_relationship($mission->guid, 'mission_accepted', elgg_get_logged_in_user_guid())) {
				$button_three = '<div id="withdraw-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
 ...
 */
 function mm_create_button_set_full($mission) {
 	...
 	if ($mission->owner_guid == elgg_get_logged_in_user_guid() && ($mission->state == 'completed' || $mission->state == 'cancelled') && elgg_get_plugin_setting('mission_developer_tools_on', 'missions') == 'YES') {
 		$returner['reopen_button'] = '<div id="reopen-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
 	...
 	if ($mission->owner_guid == elgg_get_logged_in_user_guid() && $mission->state != 'cancelled' && $mission->state != 'completed') {
 		...
 		$returner['complete_button'] = '<div id="complete-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
				'href' => elgg_get_site_url() . 'action/missions/complete-mission?mission_guid=' . $mission->guid,
				'text' => elgg_echo('missions:complete'),
		        'is_action' => true,
				'class' => 'elgg-button btn btn-success',
 		...
 		$returner['cancel_button'] = '<div id="cancel-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
 	...
 	if($mission->owner_guid == elgg_get_logged_in_user_guid() && elgg_get_plugin_setting('mission_developer_tools_on', 'missions') == 'YES') {
 		$returner['delete_button'] = '<div id="delete-button-mission-' . $mission->guid . '" style="display:inline-block;">' . elgg_view('output/url', array(
