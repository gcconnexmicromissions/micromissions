...
<div>
	<table class="mission-post-table">
		...
		<tr>
			<td class="mission-post-table-lefty">
				<label><?php echo elgg_echo('missions:opportunity_number') . ':';?></label><br />
			</td>
			<td class="mission-post-table-righty"> <div>
		...
		<tr>
			<td class="mission-post-table-lefty">
				<label><?php echo elgg_echo('missions:ideal_start_date') . ':';?></label><br />
			</td>
			<td class="mission-post-table-righty"> <div>
		...
		<tr>
			<td class="mission-post-table-lefty">
				<label><?php echo elgg_echo('missions:ideal_completion_date') . ':';?></label><br />
			</td>
			<td class="mission-post-table-righty"> <div>
		...
		<tr>
			...
			<td class="mission-post-table-righty-longer"> <div>
				<?php echo $input_skills; ?>
			</div> </td>
		</tr>
		<tr>
			<td class="mission-post-table-lefty">
				<label><?php echo elgg_echo('missions:application_deadline') . ':';?></label><br />
			</td>
			<td class="mission-post-table-righty"> <div>
		...
		<tr>
			<td class="mission-post-table-lefty">
				<label><?php echo elgg_echo('missions:opportunity_description') . ':';?></label><br />
			</td>
			<td class="mission-post-table-righty-longer"> <div>
