...
$input_flexibility = elgg_view('input/radio', array(
    ...
    'value' => $flexibility,
    'options' => array(
        elgg_echo('missions:flexible') => 'flexible',
...
<div>
    ...
    ?>
		...
		<tr>
			<td class="mission-post-table-lefty"><label for='post-mission-remotely-checkbox-input'><?php echo elgg_echo('missions:work_remotely') . ':';?></label><br />
			</td>
			<td class="mission-post-table-righty">
				<div>
		...
		<tr>
			<td class="mission-post-table-lefty"><label for='post-mission-security-dropdown-input'><?php echo elgg_echo('missions:security_level') . ':';?></label><br />
			</td>
			<td class="mission-post-table-righty">
				<div>
